...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            cam = CSICamera(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, framerate=cfg.CAMERA_FRAMERATE, gstreamer_flip=cfg.CSIC_CAM_GSTREAMER_FLIP_PARM, capture_width=cfg.CAMERA_CAPTURE_W, capture_height=cfg.CAMERA_CAPTURE_H)
